...
<fmt:bundle basename="applicationresource" prefix="page.admin.directors.">
<head>
        ...
        <table class="table table-hover table-striped center-class">
            <thead>
                <tr>
                    ...
                    <th><a href="/controller?command=create_director&code=${newCode}" class="btn btn-default"><fmt:message key="button.add"/></a> </th>
                </tr>
            </thead>
            <c:forEach var="director" items="${directors}">
                ...
                <div class="modal fade" id="modal-${director.id}">
