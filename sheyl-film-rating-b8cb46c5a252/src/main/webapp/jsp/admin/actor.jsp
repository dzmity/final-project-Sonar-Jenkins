        ...
        <form class="form-horizontal" role="form" name="updateFilmForm" action="controller" method="POST">
            ...
            <c:choose >
                <c:when  test= "${!empty actor}">
                    <input type="hidden" name="command" value="update_actor" />
            ...
            <div class="col-lg-7" >
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input required name="name" id="name" class="form-control" value="${actor.name}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input required name="surname" id="surname" class="form-control" value="${actor.surname}">
                    </div>
                </div>

                <div class="form-group">
                    <label for="dob" class="col-lg-2 control-label"><fmt:message key="dob"/></label>
                    <div class="col-lg-10">
                        <input type="date" required name="dob" id="dob" pattern="^(19|20)\d\d-(0[1-9]|1[0-2])-(0[1-9]|[1-2]\d|3[0-1])$"
                               class="form-control" value="${actor.dateOfBirth}">
                    </div>
                </div>

                <div class="form-group">
                    <label for="height" class="col-lg-2 control-label"><fmt:message key="height"/></label>
                    <div class="col-lg-10">
                        <input required type="number" name="height" id="height" class="form-control" value="${actor.height}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                        <input required type="text" name="photo"  class="form-control" id="photo" value="${actor.photoPath}">
                    </div>
                ...
                <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="${pageContext.request.contextPath}/controller" method="post" onSubmit="return checkFile(this)" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="folder" value="actor">
