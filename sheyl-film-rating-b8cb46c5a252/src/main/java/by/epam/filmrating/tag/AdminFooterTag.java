...
/**
 * The {@code AdminFooterTag} class represents the custom tag {@code adminFooter}
 * in {@code customtags} library used in jsp-fills
 * @author Dmitry Rafalovich
 *
 */
public class AdminFooterTag extends TagSupport {

    private static final String NAVBAR = "<div class=\"navbar navbar-inverse navbar-fixed-bottom\">";
