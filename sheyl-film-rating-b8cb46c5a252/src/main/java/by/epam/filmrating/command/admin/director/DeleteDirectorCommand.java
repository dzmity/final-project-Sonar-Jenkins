...
/**
 * The {@code DeleteDirectorCommand} class is participant in Command Pattern.
 * It is a concrete class extends the {@link ActionCommand}.
 * The class is responsible for deleting {@code Director} object.
 * @author Dmitry Rafalovich
 */
public class DeleteDirectorCommand implements ActionCommand {
    ...
    public String execute(SessionRequestContent content) {
        ...
        if (content.getRequestParameters().get(ID) == null) {
            LOG.error("Exception in DeleteDirectorCommand. Missing Id parameter.");
            return PathManager.getProperty(INDEX_PATH);
        }
        ...
        try {
            ...
            LOG.error("Exception in DeleteDirectorCommand", e);
        }
